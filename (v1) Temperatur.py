...
#Zeit (Sekunden)
x = np.array([80, 90, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250, 260, 270, 280, 290, 300, 310, 320, 330, 340, 350, 360, 370, 380, 390, 400, 410, 420, 430])
# Temperatur (Grad Celsius)
y = np.array([13.44, 13.35, 12.76, 12.26, 11.92, 11.75, 11.61, 11.24, 10.87, 10.34, 9.69, 9.27, 9.01, 8.62, 8.18, 7.81, 7.53, 7.19, 6.19, 6.73, 6.43, 6.16, 6.01, 5.93, 5.7, 5.34, 5.28, 5.24, 5.05, 4.97, 4.87, 4.81, 4.68, 4.51, 4.39, 4.33])
